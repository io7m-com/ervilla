...
import com.io7m.ervilla.keycloak.EKcSpecs;
...
public final class EKcTest
{
  ...
  public static void setupOnce(
    ...
    final @TempDir Path temporaryDirectory)
    throws Exception
  {
    final var file =
      temporaryDirectory.resolve("realm.json");
...
""");
    ...
    throws Exception
  {
    ...
    final var request =
      HttpRequest.newBuilder(URI.create("http://0.0.0.0:8080"))
        .build();
